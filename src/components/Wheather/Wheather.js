...
const Wheather = () => {
  ...
  //search wheather
  const [searchWheather, setSearchWheather] = useState("Noida");
  ...
  const getWheather = async () => {
    try {
      let url = `https://api.openweathermap.org/data/2.5/weather?q=${searchWheather}&units=metric&appid=8decdfd138a08b4877956eecfbc70743`;
